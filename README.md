...
**Current stage**  
The Game is at an early development stage (~24% finished). It's developed on Python 3.7 and Panda3D game engine, models are created with Blender and MakeHuman.
...
- two seamlessly changing game modes: traveling and fighting
- one class of characters with some behavior
- one class of enemies
- some physics, day-night change and particle effects
- common strategic controls
- several tactical elements: chance of enemy attack differs in different day times, characters with low energy level have less accuracy, etc.
