...
**Current stage**  
The Game is at an development stage (~54% finished). It's developed on Python 3.7 and Panda3D game engine, models are created with Blender and MakeHuman.
...
- outings, diseases, the Stench, randomly build world, etc.
